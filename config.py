...
class Config:
    ...
    def __init__(self):
        ...
        # Web access
        self.allow_web = os.getenv("JJ_ALLOW_WEB", "0") == "1" if self.is_production else True
        
        # Runtime mode
        self.runtime = os.getenv("JJ_RUNTIME", "localsafe").lower()  # localsafe or sandboxed
    ...
    def load_capabilities(self, agent_dir: Path, workspace: Path) -> Dict[str, Any]:
        ...
        if not capabilities_file.exists():
            ...
            return {
                ...
                "budgets": {
                    "job_minutes": self.max_job_minutes,
                    "web_dollars": 2.00
                },
                "timeouts": {
