...
class WebTool:
    ...
    def __init__(self, workspace: Path, capabilities: Dict[str, Any]):
        ...
        self.allow_web = self.network_config.get("allow_web", False) and config.allow_web
    ...
    def _check_domain(self, url: str) -> tuple[bool, Optional[str]]:
        ...
        if not self.allow_web:
            return False, "Web access is disabled. Set JJ_ALLOW_WEB=1 and configure allowed_domains."
        ...
        try:
            ...
            if not self.allowed_domains:
                return False, "No allowed domains configured. Web access requires domain allowlist."
